...
The `Slurm documentation <https://slurm.schedmd.com/sbatch.html>`_ is a great place to see them all, and please refer to the :doc:`Specific application guides </applications/index>` section for more some specialised jobscript examples.
